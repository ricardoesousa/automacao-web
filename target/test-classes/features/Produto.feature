...
Funcionalidade: Produto
  ...
  Esquema do Cenário: "CT <ct>" - Inserir produto no carrinho de compras
    ...
    Exemplos:
      ...
      | 001 | Ração      | 3         | Ração Golden Fórmula Senior para Cães Adultos Sabor Frango e Arroz - 15kg | Premier Pet | R$ 150,90    | R$ 135,81       |
